...
const Description = () => {
    ...
    return (
        <div>
             <Typography sx={{color:"#727475",fontWeight:700,fontSize:"30px",lineHeight:3,letterSpacing:1}} variant="h5" gutterBottom component="div">
       Short Description About Our School
      </Typography>
           <Typography sx={{textAlign:"justify",mb:6,color:"#a3a3a3",fontSize: "16px",lineHeight: 2,letterSpacing:1}} variant="body1" gutterBottom>
           ...
           <Typography sx={{textAlign:"justify",mb:6,color:"#a3a3a3",fontSize: "16px",lineHeight: 2,letterSpacing:1}} variant="body1" gutterBottom>
        Alternative name of our school is <span style={{ color:"#727475",fontWeight:"bold", letterSpacing: "1px", }}>{description?.schoolName}</span>  which is 
      ...
      <Typography sx={{textAlign:"justify",mb:10,color:"#a3a3a3",fontSize: "16px",lineHeight: 2,letterSpacing:1}} variant="body1" gutterBottom>
