...
const Subscribe = () => {
    return (
        <div>
            ...
            <h1 className="underline decoration-green-500 text-4xl text-green-900 font-bold">Be a Subscriber</h1>
            ...
            <div class="2xl:mx-auto 2xl:container mx-4 py-16">
                ...
                <div class="w-full relative flex items-center justify-center">
                    ...
                    <div class="bg-gray-800 bg-opacity-60 md:my-16 lg:py-16 py-10 w-full md:mx-24 md:px-12 px-4 flex flex-col items-center justify-center relative z-40">
