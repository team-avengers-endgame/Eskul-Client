    ...
    <div>
      <footer class="footer" >
        <div class="grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-x-16 py-8 px-6  ">
          ...
          <div>
            <h3 className="mb-6 text-lg font-semibold text-gray-400 uppercase text-left">
              Get In Touch
            </h3>
            <div className="text-lg">
              <ul>
                ...
                <li className="text-left">
                  ...
                  ></i>{" "}
                  <span style={{ color: "#fff" }}>770-123-4567</span>
                </li>
              </ul>
            </div>
            <br />
        ...
        <div className="py-6 px-4 bg-gray-700 text-center">
          <span className="text-md font-bold text-gray-300 text-center ">
