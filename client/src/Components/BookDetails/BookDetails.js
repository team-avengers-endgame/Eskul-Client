    ...
    return (
      ...
      <Box sx={{  textAlign: "center" , my: 5 }}>
       ...
       <Grid container  columns={{ xs: 4, sm: 8, md: 12 ,lg:12}}>
                 ...
                 <Grid container spacing={5} columns={{ xs: 4, sm: 8, md: 12 }}>
                                    ...
                                    <Grid  item xs={4} sm={4} md={8} sx={{mb:5}}>
                                        ...
                                        <Box sx={{textAlign: "justify"}}>
                                            ...
                                            <span style={{ fontWeight: 700 }}> সারসংক্ষেপঃ </span>  {book?.bookDescription}
                                            </Typography>
                                    ...
                                    <Grid item xs={4} sm={4} md={4}>
                                        ...
                                        <CardMedia
                                            component="img" alt="complex" src={book?.bookImg} />
            ...
            <span style={iconStyle}> <BorderColorIcon color="primary" /><Typography variant='body1' > লেখক: {book?.author}</Typography></span>
            <br />
            <span style={iconStyle}> <PublishIcon color="primary" /><Typography variant='body1' >
            প্রকাশকঃ {book?.publisher}</Typography></span>
            <br />
            <span style={iconStyle}> <DateRangeIcon color="primary" /><Typography variant='body1' >প্রকাশিত তারিখঃ {book?.publishedDate} </Typography></span>
            <br />
            <span style={iconStyle}> <AppRegistrationIcon color="primary" /><Typography variant='body1' >বইয়ের ধরন: {book?.type}</Typography></span>

            <br />
            <span style={iconStyle}> <PaidIcon color="primary" /><Typography variant='body1' > মূল্যঃ ৳ {book?.bookPrice}</Typography></span>
            <br />
