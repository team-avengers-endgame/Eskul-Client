...
const Features = () => {
    ...
    return (
        <Box sx={{
            ...
            <Container >
                <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 9 }} sx={{ alignItems: 'center' }}>
                    <Grid item xs={12} sm={12} md={8}>
                        ...
                        <Box>
                            <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }} sx={{ alignItems: 'center' }} columns={{ xs: 12, sm: 8, md: 12 }}>
